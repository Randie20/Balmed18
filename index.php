...
<section class="hero">
    <div class="container hero-grid">
        <div class="hero-copy">
            ...
            <h1>Lip love,<br><em>bottled in a tube.</em></h1>
            <p>
            ...
            <div class="hero-actions">
                ...
                <a class="text-link" href="#story">Our story <span>↗</span></a>
            </div>

            <div class="hero-stats">
                <span><strong>Small batch</strong>Thoughtfully made</span>
                <span><strong>Kenyan made</strong>Made in Nairobi</span>
                <span><strong>Everyday care</strong>Simple rituals</span>
            </div>
        </div>

        <div class="hero-art">
            <img src="<?= url('assets/images/hero.svg') ?>" alt="Balmed 18 product illustration">
        </div>
    </div>
</section>
...
<section class="section collection-section">
    <div class="container">
        <div class="section-heading">
            ...
            <a class="text-link" href="<?= url('products.php') ?>">View all <span>↗</span></a>
        </div>
        ...
        <?php else: ?>
            <div class="empty-state">
                ...
                <p>
                    Products added through the Balmed 18 admin dashboard will
    ...
    <div class="container story-grid">
        <div class="story-art">
            <div class="story-card">
                ...
                <strong>From Nairobi,<br>with love.</strong>
            </div>
        </div>

        <div class="story-copy">
            <span class="eyebrow">Our story</span>
            <h2>Simple ingredients.<br>Thoughtful rituals.</h2>
            <p>
...
<section class="why-section section" id="why-us">
    <div class="container">
        <div class="section-heading centered">
            ...
            <h2>Care that fits your everyday.</h2>
        </div>
        ...
        <div class="feature-grid">
            <article>
                <span>01</span>
                <h3>Small batch</h3>
                <p>Made thoughtfully so every product gets the attention it deserves.</p>
            </article>

            <article>
                <span>02</span>
                <h3>Made in Nairobi</h3>
                <p>Rooted locally, inspired by the warmth and creativity around us.</p>
            </article>

            <article>
                <span>03</span>
                <h3>Made to be used</h3>
                <p>Simple, practical self-care designed for real everyday routines.</p>
            </article>
        </div>
    </div>
</section>
...
<section class="cta-section">
    <div class="container cta-inner">
        <div>
            <span class="eyebrow">Find your everyday favourite</span>
            <h2>Ready for a little<br>Balmed 18 love?</h2>
        </div>
        <a class="btn btn-light" href="<?= url('products.php') ?>">Shop now</a>
    </div>
</section>
